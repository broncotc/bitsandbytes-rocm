...
hip: $(BUILD_DIR)
	...
	# /opt/rocm/bin/hipcc -fPIC -static $(BUILD_DIR)/ops.o $(BUILD_DIR)/kernels.o -o $(BUILD_DIR)/link.so 
...
cleanlibs:
	rm ./bitsandbytes/libbitsandbytes*.soMKFILE_PATH := $(abspath $(lastword $(MAKEFILE_LIST)))
ROOT_DIR := $(patsubst %/,%,$(dir $(MKFILE_PATH)))
